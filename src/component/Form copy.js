      ...
      <div>
        ...
        <form className={classes.container} onSubmit={this.handleSubmit} autoComplete="off" noValidate={(this.props.novalidate) ? this.props.novalidate : false}>
          {fields.map(formField => {
            ...
            let formFieldKey = `form-control-${formField.name}`;
            switch(formField.type) {
              ...
              case 'checkbox':
                field = (fieldOptions) ? (
                  <FormControl component="fieldset" required={formField.required} className={classes.textField} key={formFieldKey} error={formField.error} aria-describedby={`${formField.name}-error-text`} >
                    <FormLabel component="legend">{formField.label}</FormLabel>
                    <FormGroup
                      aria-label={formField.label}
                      className={classes.group}
              ...
              default:
                field = (fieldOptions.length > 0) ? (
                  ...
                  (
                    <FormControl component="fieldset" required={(formField.required) ? true : false} 
                      className={classes.textField} 
                      key={formFieldKey}
                    >
                      <FormLabel component="legend">{formField.label}</FormLabel>
                    ...
                    <FormControl component="fieldset" required={(formField.required) ? true : false} className={classes.textField} key={formFieldKey}>
                      <FormLabel component="legend">{formField.label}</FormLabel>
                      <RadioGroup
                        aria-label={formField.label}
                        className={classes.group}
