      ...
      >
        <TextField
          ...
          InputProps={{ 
            ...
            startAdornment: (this.props.prefix) ? (<InputAdornment position="start">{this.props.prefix}</InputAdornment>) : null,
            endAdornment: (this.props.suffix) ? (<InputAdornment position="end">{this.props.suffix}</InputAdornment>) : null,
            inputProps: {
